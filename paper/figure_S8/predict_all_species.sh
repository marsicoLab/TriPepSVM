...
bash ../../TriPepSVM.sh -i ../data/proteome_9606.fasta -o ../data/cross_species/561_on_9606_proteome/ -id 561 -pos 1.0 -neg 0.1 -m trainData
...
bash ../../TriPepSVM.sh -i ../data/proteome_99287.fasta -o ../data/cross_species/561_on_590_proteome -id 561 -pos 1.0 -neg 0.1 -m trainData
